...
+ (GADPreloadConfiguration *_Nonnull)preloadConfiguration:
    (GADUPreloadConfiguration *_Nonnull)config;

+ (GADUPreloadConfiguration *_Nonnull)internalPreloadConfiguration:
    (GADPreloadConfiguration *_Nonnull)config;
